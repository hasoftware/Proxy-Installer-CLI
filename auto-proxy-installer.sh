...
# Source libraries
. "$SCRIPT_DIR/lib/utils.sh" || { echo "Error: Cannot load utils.sh"; exit 1; }
. "$SCRIPT_DIR/lib/os_detect.sh" || { echo "Error: Cannot load os_detect.sh"; exit 1; }
. "$SCRIPT_DIR/lib/pkg.sh" || { echo "Error: Cannot load pkg.sh"; exit 1; }
. "$SCRIPT_DIR/lib/firewall.sh" || { echo "Error: Cannot load firewall.sh"; exit 1; }

# Source modules
. "$SCRIPT_DIR/modules/http_squid.sh" || { echo "Error: Cannot load http_squid.sh"; exit 1; }
. "$SCRIPT_DIR/modules/socks5.sh" || { echo "Error: Cannot load socks5.sh"; exit 1; }
. "$SCRIPT_DIR/modules/shadowsocks.sh" || { echo "Error: Cannot load shadowsocks.sh"; exit 1; }
. "$SCRIPT_DIR/modules/uninstall.sh" || { echo "Error: Cannot load uninstall.sh"; exit 1; }
. "$SCRIPT_DIR/modules/check_proxies.sh" || { echo "Error: Cannot load check_proxies.sh"; exit 1; }
